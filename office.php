...
<html>
    ...
    <body style="margin: 0px;padding: 0px;" >
        ...
        <div id="main">
            ...
            <div id="rightmain">
                <div id="shop">
                    <a href="office.php" class="holder"style="background-color: black;color: white;border: 2px solid white;">Office</a>
                    <a href="bedroom.php" class="holder">Bedroom</a>
                    <a href="drawing.php" class="holder">Drawing</a>
                    <a href="dining.php" class="holder">Dining</a>
                </div>
                
                 <?php
                $sql="select * from items where catagory='office';";
